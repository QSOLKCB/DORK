...
; ---------------------------------------------------------------------------
; DORK-specific meme verbs.  These map player input to custom routines in
; GVERBS.ZIL.  They take no direct objects.
; ---------------------------------------------------------------------------

<SYNTAX SHITPOST = V-SHITPOST>
<SYNTAX RATIO = V-RATIO>
<SYNTAX BLOCK = V-BLOCK>
<SYNTAX LURK = V-LURK>

<SYNONYM SHITPOST SHITPOSTING POST>
<SYNONYM RATIO RATIOED RATIOING>
<SYNONYM BLOCK BLOCKS BLOCKING>
<SYNONYM LURK LURKING LURKER>