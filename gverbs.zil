...
<ROUTINE V-VERSION ("AUX" (CNT 17))
	%<COND (<==? ,ZORK-NUMBER 1>
       '<TELL "DORK: A Meme‑Dungeon of the Internet|
Infocom interactive fiction remixed into a meme‑dungeon by QSOL‑IMC|
Based on Zork I. Copyright (c) 1981–1986 Infocom; modifications © 2025">)
	       (<==? ,ZORK-NUMBER 2>
...
; ---------------------------------------------------------------------------
; DORK-specific verbs.  These routines handle meme-centric actions such as
; shitposting, blocking and ratioing.  They don't materially change game
; state but provide color commentary.
; ---------------------------------------------------------------------------

<ROUTINE V-SHITPOST ()
    <TELL "You unleash a deeply cursed post. Somewhere, a brand account steals it." CR>>

<ROUTINE V-RATIO ()
    <TELL "You attempt to ratio, but the algorithm is indifferent." CR>>

<ROUTINE V-BLOCK ()
    <TELL "With a flick of your wrist you block the offending account, basking in smugness." CR>>

<ROUTINE V-LURK ()
    <TELL "You decide to silently lurk, consuming content without contributing." CR>>